...
function preload() {
  ...
  enemy1Img = loadImage('pig_1.png');
  enemy2Img = loadImage('pig_2.png');
  enemy3Img = loadImage('pig_3.png');
  enemy1ImgWeak = loadImage('pig_1.png');
  enemy2ImgWeak = loadImage('pig_2.png');
  enemy3ImgWeak = loadImage('pig_3.png');
}
